...
export const verifyCodeOrResetTokenSchema = z.object({
  code: z.string().length(6, 'Code must be exactly 6 characters').transform((val) => val.toUpperCase()).optional(),
...
export type VerifyCodeOrResetTokenFormData = z.infer<typeof verifyCodeOrResetTokenSchema>;
