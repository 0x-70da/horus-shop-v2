...
export default function CheckoutPaymentStatusPage() {
  ...
  return (
    <div className="container max-w-md py-20 text-center space-y-4">
      {status === "success" && (
        <>
          <div className="w-16 h-16 bg-green-100 rounded-full flex items-center justify-center mx-auto text-2xl">✓</div>
      ...
      {status === "processing" && (
        <>
          <div className="w-16 h-16 bg-yellow-100 rounded-full flex items-center justify-center mx-auto text-2xl">⏳</div>
      ...
      {status === "failed" && (
        <>
          <div className="w-16 h-16 bg-red-100 rounded-full flex items-center justify-center mx-auto text-2xl">✕</div>
